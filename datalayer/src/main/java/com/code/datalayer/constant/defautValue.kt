...
val taskDf : Task = Task(null,"learn compose ui" , strategyDf.name,0, dateDf.toString(), startDf, endDf, requireDf.toString(),doneDf.toString())
val taskDf1 : Task = Task(null,"learn compose ui" , strategyDf.name,0, dateDf.toString(),startDf, endDf, requireDf.toString(),doneDf.toString())